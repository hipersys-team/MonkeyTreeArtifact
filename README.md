...
The first main result varies the load and measures the slowdown values of traces of jobs across different systems.
```
...
This experiment varies the oversubscription ratio by iterating over the number of spine switches and the number of GPUs per ToR.
